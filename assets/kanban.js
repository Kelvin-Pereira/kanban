  ...
  this.jKanban = function() {
    ...
    this.addBoards = function(boards, isInit) {
      ...
      for (var boardkey in boards) {
        ...
        headerBoard.classList.add("header"); // 'kanban-board-header' add essa class para mover os blocos
        allClasses.map(function(value) {
          headerBoard.classList.add(value);
        });
        headerBoard.innerHTML =
          // '<div class="kanban-title-boards">' + board.title + "</div>";   // add quanticades de card
          '<div class="kanban-title-boards">' + board.title + "<span class='size' id='"+ board.id +"'>"+ board.item.length +"</span></div>";   // add quanticades de card
        ...
        for (var itemkey in board.item) {
          ...
          var nodeItem = document.createElement("div");
          nodeItem.classList.add("kanban-item");
          nodeItem.classList.add("item_handle");
          if (itemKanban.id) {
